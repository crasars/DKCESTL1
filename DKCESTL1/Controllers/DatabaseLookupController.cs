...
namespace DKCESTL1.Controllers
{
    ...
    public class DatabaseLookupController : ControllerBase
    {
        ...
        public string disableCity(string city)
        {
            ...
            string query = "UPDATE dbo.map SET available = 0 WHERE city1 LIKE '" + city + "' OR city2 LIKE '" + city + "';";
        ...
        public string enableCity(string city)
        {
            ...
            string query = "UPDATE dbo.map SET available = 1 WHERE city1 LIKE '" + city + "' OR city2 LIKE '" + city + "';";
